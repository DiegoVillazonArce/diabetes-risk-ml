...
The P8 stories -- US-0601 (calibration evaluation and selection), US-0606 (threshold analysis and trade-offs), and US-0607 (schema-version-2 artifact and app integration) -- were refined to Ready on 2026-07-11 and implemented locally on 2026-07-12/13. D-018 and D-019 are Accepted; US-0601 and US-0606 are Done. US-0607 remains In Progress only for commit/push, Streamlit redeploy, and public smoke verification of the prepared version-2 artifact. The leakage-safe protocol lives in `docs/ml-analysis-plan.md`, evidence in `docs/p8-calibration/report.md`, and execution history in `docs/iteration-log.md`. The remaining stories stay Deferred for their later phases: SHAP (P9), scenario exploration (P10), batch prediction (P11), and fairness audit (P12).
...
- [x] Regenerate the official version-2 artifact per D-013 and verify it locally/headlessly, including the reference suite. The artifact remains unstaged pending review.
- [ ] After review, commit and push the implementation, let Streamlit redeploy, and rerun the four public profiles plus startup/form/disclaimer smoke checks. This external gate is the only remaining US-0607/P8 closure task.
